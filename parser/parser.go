...
var (
	...
	// VersionX is a copy of Version2 with experimental support for GROQ fragments.
	// Experimental: This is only an experimental version and may change at any time.
	VersionX Version = 0
)
